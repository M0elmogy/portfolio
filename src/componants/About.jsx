...
function About() {
    return (
        ...
        <div className=' animate__animated animate__flipInX   mx-auto grid  md:grid-cols-2 px-12  py-11 w-[90%] sm:items-center    shadow-2xl shadow-red-500 '>
            <div >
                <img className='sm:w-[80%] md:w-[90%]' src={frontt} alt="" srcset="" />
            </div>
            <div className='text-white md:mr-6 w-full   '>
                <h1 id='about' className='text-2xl font-sans py-3'>ABOUT MY..</h1>
                <p id='about2' className=''>More than 3 years Experience in the development of software and solutions.
